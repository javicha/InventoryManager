...
namespace Inventory.Synchro.Extensions
{
#pragma warning disable CS8620, CS8631
    public static class HostExtensions
    {
        ...
        private static void InvokeSeeder<TContext>(Action<TContext, IServiceProvider> seeder, TContext context, IServiceProvider services) where TContext : InventoryContext
        {
            seeder(context, services);
        }
    }
}
#pragma warning restore CS1591, CS8631